...
class Places(data.Dataset):
    ...
    def __init__(self, image_dir, transform, mode):
        ...
        self.val_dataset = []
        self.test_dataset = []
        self.train_txt = "./Places_LT_train.txt"
        self.val_txt = "./Places_LT_val.txt"
        self.test_txt = "./Places_LT_test.txt"
        self.cls_num_list_train = [0]*365
        self.cls_num_list_val = [0]*365
        self.cls_num_list_test = [0]*365
        self.preprocess()
