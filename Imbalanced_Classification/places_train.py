...
parser.add_argument('--epoch_thresh', default=9, type=int, metavar='N',
...
def main():
    ...
    args.store_name = '_'.join(['Places_LT', args.arch])
...
def main_worker(gpu, ngpus_per_node, args):
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        criterion = LDAMLoss(cls_num_list=args.cls_num_list, max_m=0.2, s = 50, weight=per_cls_weights).cuda()
