...
parser.add_argument('--wd', '--weight-decay', default=5e-5, type=float,
                    ...
                    dest='weight_decay')
parser.add_argument('--epoch_thresh', default=139, type=int, metavar='N',
...
parser.add_argument('--root_model', type=str, default='checkpoint_inaturalist_RSG')
...
def main():
    ...
    main_worker(ngpus_per_node, ngpus_per_node, args)
...
def main_worker(gpu, ngpus_per_node, args):
    ...
    train_dataset = iNaturalist(args.image_dir, transform_train, 'train')
    val_dataset = iNaturalist(args.image_dir, transform_val, 'val')
    ...
    device_ids = [i for i in range(gpu)]
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        criterion = LDAMLoss(cls_num_list=args.cls_num_list, max_m=0.1, s=50, weight=per_cls_weights).cuda()
